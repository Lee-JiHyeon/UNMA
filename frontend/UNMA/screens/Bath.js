...
class Bath extends Component {
  ...
  componentDidMount() {
    ...
    AsyncStorage.getItem('childPk', (err, res) => {
      ...
      .then((res) => {
        console.log(res)
        this.setState({ bathitems: res.data })
      })
      .catch((err) => {
        console.error(err)
      })
    ...
    return (
      <Block>
        ...
        /> */}
          ...
          <Image
          resizeMode='stretch'
          source={{uri : 'https://image.freepik.com/free-vector/bathroom-background-design_1294-83.jpg'}} style={styles.background}></Image>
        </Block>
      </Block>
    );
  }
