...
class Room extends Component {
  ...
  componentDidMount() {
    ...
    AsyncStorage.getItem('childPk', (err, res) => {
      ...
      .then((res) => {
        console.log(res)
        this.setState({ roomitems: res.data })
      })
      .catch((err) => {
        console.error(err)
      })
    ...
    return (
      <Block>
        ...
        /> */}
          ...
          <Image 
          resizeMode='stretch'
          source={{uri : 'https://image.freepik.com/free-vector/beautiful-baby-bed-room-scene_25030-39886.jpg'}} style={styles.background}></Image>
        </Block>
      </Block>
    );
  }
