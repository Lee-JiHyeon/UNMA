...
class Ski extends Component {
  ...
  componentDidMount() {
    ...
    AsyncStorage.getItem('childPk', (err, res) => {
      ...
      .then((res) => {
        console.log(res)
        this.setState({ skiitems: res.data })
      })
      .catch((err) => {
        console.error(err)
      })
    ...
    return (
      <Block>
        ...
        <Block style={styles.container}>
          {/* <LottieView
          source={require("../animations/50649-sunny.json")}
          autoPlay
          style={styles.sun}
        /> */}
          ...
          <Image 
          resizeMode='stretch'
          source={{uri : 'https://image.freepik.com/free-vector/vector-character-with-bear-penguin-skiing-snow_1150-34912.jpg'}} style={styles.background}></Image>
        </Block>
      </Block>
    );
  }
