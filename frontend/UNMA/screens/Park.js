...
class Park extends Component {
  ...
  componentDidMount() {
    ...
    AsyncStorage.getItem('childPk', (err, res) => {
      ...
      .then((res) => {
        console.log(res)
        this.setState({ parkitems: res.data })
      })
      .catch((err) => {
        console.error(err)
      })
    ...
    return (
      <Block>
        ...
        <Block style={styles.container}>
          ...
          <Image 
          resizeMode='stretch'
          source={{uri : 'https://image.freepik.com/free-vector/vector-illustration-cartoon-city-park-panoramas_81522-742.jpg'}} style={styles.background}></Image>
        </Block>
      </Block>
    );
  }
